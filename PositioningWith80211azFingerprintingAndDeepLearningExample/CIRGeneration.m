    ...
    if distribution == "uniform"
        [APs,STAs] = CIRdlPositioningCreateEnvironment(txArraySize,rxArraySize,staSeparation,"uniform");
    else
        [APs,STAs] = CIRdlPositioningCreateEnvironment(txArraySize,rxArraySize,numSTAs,"random");
    end
    ...
    [features,labels] = CIRdlPositioningGenerateDataSet(rays,STAs,APs,cfg,snr);
